...
expr    	:	term									{$$.i = $1.i;								$$.f = $1.f;}
			...
			|	ID '+' factor							{$$.i = checkThisNumVar($1.c) + $3.i;		$$.f = checkThisNumVar($1.c) + $3.f;}
        	|	factor '+' ID							{$$.i = $1.i + checkThisNumVar($3.c);		$$.f = $1.f + checkThisNumVar($3.c);}
       	    |	expr '-' term							{$$.i = $1.i - $3.i;						$$.f = $1.f - $3.f;}
			|	ID '-' factor							{$$.i = checkThisNumVar($1.c) - $3.i;		$$.f = checkThisNumVar($1.c) - $3.f;}
        	|	factor '-' ID							{$$.i= $1.i - checkThisNumVar($3.c);		$$.f= $1.f - checkThisNumVar($3.c);}
       	    ;
...
factor		:	values									{$$.i = $1.i;								$$.f = $1.f;}
			|	'(' expr ')'							{$$.i = $2.i;								$$.f = $2.f;}		
			|	'-' values  %prec UMINUS   				{$$.i = -$2.i; 								$$.f = -$2.f;}
