...
num_statements		:	IDENTIFIER ':' type				{checkVarDup($1.c, $3.c);}
...
let_statements		:	IDENTIFIER ':' CHAR				{checkVarDup($1.c, $3.c);}
					|	IDENTIFIER '=' str					{checkVarExist($1.c, $3.i, $3.f, $3.c);}
					|	IDENTIFIER ':' CHAR '=' str		{
															checkVarDup($1.c, $3.c);
															registThisVal($1.c ,$5.i, $5.f, $5.c);
															updateVal($1.c ,$5.i, $5.f, $5.c);
...
values		:	IDENTIFIER														{$$.i = checkThisNumVar($1.c); $$.f = checkThisNumVar($1.c);}
			|	INTEGERS														{$$.i = $1.i;}
			|	DECIMALS														{$$.f = $1.f;}
			;

/* str can be either character or variable holding the value */
str			:	IDENTIFIER														{$$.c = checkThisCharVar($1.c);}
			|	CHARACTER														{$$.c = $1.c;}
			|	STRING															{$$.c = $1.c;}
			;
